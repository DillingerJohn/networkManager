...
using NetworkManager.Data.Configurations;
...
{
    public class NetAppDbContext : IdentityDbContext<ApplicationUser>, IDbContext
    {
        ...
        public NetAppDbContext()
            : base("AppDbConnection")
        {

        }

        public NetAppDbContext(string nameOrConnectionString, ILogger logger)
        ...
        public static NetAppDbContext Create()
        {
            return new NetAppDbContext(nameOrConnectionString: "AppDbConnection", logger: null);
        }
